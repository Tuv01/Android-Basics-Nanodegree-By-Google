...
/**
 * Created by Tuv01 on 22.04.2018.
 */

/**
 * {@link InventoryProvider} for Inventory app.
 */
public class InventoryProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.tuv01.inventoryapp/product/" will map to the
        ...
        // For example, "content://com.tuv01.inventoryapp/product/products/3" matches, but
        // "content://com.tuv01.inventoryapp/product/products" (without a number at the end) doesn't match.
        sUriMatcher.addURI(InventoryContract.CONTENT_AUTHORITY, InventoryContract.PATH_INVENTORY
                + "/#", PRODUCT_ID);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case PRODUCT:
                // For the PRODUCT code, query the inventory table directly with the given
            ...
            case PRODUCT_ID:
                ...
                // For an example URI such as "content://com.tuv01.inventoryapp/product/products/3",
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        String imageURi = values.getAsString(InventoryEntry.COLUMN_PRODUCT_PICTURE);
        if (imageURi == null) {
        ...
        String supplierPhone = values.getAsString(InventoryEntry.COLUMN_PRODUCT_PHONE);
        ...
        // uri: content://com.tuv01.inventoryapp/product/
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case PRODUCT:
                ...
                rowsDeleted = database.delete(InventoryEntry.TABLE_NAME, null, null);
                break;
            case PRODUCT_ID:
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If the {@link InventoryEntry#COLUMN_PRODUCT_SUPPLIERPHONE} key is present,
        // check that the name value is not null.
